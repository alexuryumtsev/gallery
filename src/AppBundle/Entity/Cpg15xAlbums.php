 ...
 * Cpg15xAlbums
 *
 * @ORM\Table(name="cpg15x_albums", indexes={@ORM\Index(name="alb_category", columns={"category"}), @ORM\Index(name="moderator_group", columns={"moderator_group"}), @ORM\Index(name="visibility", columns={"visibility"})})
 * @ORM\Entity
 */
class Cpg15xAlbums
{
